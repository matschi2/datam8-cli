...
"""CLI sub-commands to migrate datam8 v1 solution models to the v2 format."""
...
def v1_to_v2(
    ...
    """Migrate a v1 solution to the v2 model layout, writing results to an output directory."""
